...
「Messaging API 設定」タブの下の方に、**QR コード**があります。
...
(`sk-ant-xxxxxxxxxxx` などの部分は、Part 2 で取得した**自分の値** に置き換えてください)
...
(`xxxxxxxxxx` の部分は、Part 2-3 でコピーした **自分の authtoken**に置き換えてください)
...
- X/Twitter の AI 驚き屋は全てブロックしてください
  ...
  - これらは**全部ゴミでありクソ、ノイズです**
  - 何を発信しているのか？ではなくて、**何を作っているのか**以外は信じる必要なし
